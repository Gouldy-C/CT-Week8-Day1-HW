...
function getFruit(fruit:Fruit):void {
...
enum Categories {'Shirts','Shoes','Pants','Hats'}
...
const shopItem1:ShopItem = {
  id: 1,
  price: 15.99,
  description: 'fun playful product',
...
const shopItem2:ShopItem = {
  ...
  keywords: ['fun','sturdy','adjustable']
}
...
const shopItem3:ShopItem = {
  ...
  keywords: ['fun','gorgeous','beautiful', 'dress']
}